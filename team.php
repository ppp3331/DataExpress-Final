...
<body style="background-color:#f0f4f7;">
    ...
    <div id="wrap">
        ...
        if ($result->num_rows>0)
        {
            ...
            {
                $team_id=$row["team_ID"];
                $query1="SELECT DISTINCT username from users, join1 where join1.team_ID='$team_id' and join1.email=users.email";
                ...
                if ($result1->num_rows>0)
                {
                        ...
                        while ($row1 = $result1->fetch_assoc())
                    {
                        ...
                        &nbsp; &nbsp;&nbsp;&nbsp;". $row["description"]. "</text></div></div><br><a href='home.php?tid=". $row["team_ID"]. "'>Enter</a></div>";
